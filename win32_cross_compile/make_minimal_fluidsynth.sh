...
-DCMAKE_BUILD_TYPE=Release
  ...
  # if we attempt default install, it'll build all targets, and fail on linking
  # (for example because of unsupported --as-needed flag, but can also fail if you're missing libraries)
